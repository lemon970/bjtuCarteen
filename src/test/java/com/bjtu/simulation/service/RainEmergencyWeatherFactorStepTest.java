 ...
 *
 * 该测试在后端镜像 NumberField step=0.05 的校验,验证后端预设值不违反这个跨层契约。
 * 这是 Bug-02 的"契约镜像"层防线;真正复现用户人工故障的是
 * sun/src/pages/InputPage.bug2.test.jsx + ServedFrontendBundleFreshnessTest。
 */
